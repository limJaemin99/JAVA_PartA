...
import java.util.Scanner;		//기본클래스는 java.lang에 있고 그 이외의 자바클래스는 import한다
...
public class A11KeyInputTest {
	public static void main(String[] args) {
		...
		int sum = num;	//첫번째 입력값 num이 sum의 초기값이 됨
		System.out.println("정수값 1개 입력하세요. >>>");
		num = sc.nextInt();			
		System.out.println("num = " + num);
		
		sum +=num;		//두번째 입력값 num이 sum에 더해지고 sum은 그 결과값으로 변경됨
